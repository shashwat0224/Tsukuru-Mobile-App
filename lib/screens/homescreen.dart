        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [SizedBox(height: 8,),
              ...
              SizedBox(height: 8),
              UiHelper.customText(title: 'CRAFTING CRAVINGS, ONE CLICK AWAY', size: 26, color: Color(0XFFB53145)),
              SizedBox(height: 8),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
              ...
              Row(children: [SizedBox(width: 24,),UiHelper.customText(title: 'TRENDING RECIPES', size: 24, color: Color(0XFFB53145))],),
